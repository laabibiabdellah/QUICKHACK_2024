        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="posts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('dashboard-posts.index')}}">Posts management</a></li>
              </ul>
            </div>
            </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="cities">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('dashboard-cities.index')}}">Cities Management</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{route('dashboard-cities.create')}}">Add City</a></li>
              </ul>
            </div>
            </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="companies">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('dashboard-companies.index')}}">Companies Management</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{route('dashboard-companies.create')}}">Add Company</a></li>
              </ul>
            </div>
            </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="prefectures">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('dashboard-prefectures.index')}}">Prefectures Management</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{route('dashboard-prefectures.create')}}">Add Prefecture</a></li>
              </ul>
            </div>
            </li>
