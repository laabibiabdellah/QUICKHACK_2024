                                    ...
                                    <div class="package-item">
                                        ...
                                        <div class="text-center p-4">
                                            ...
                                            <div class="d-flex justify-content-center mb-2">
                                               @auth
                                               <a href="{{route('my-posts.show', $post)}}" class="btn btn-sm btn-primary px-3 border-end" style="border-radius: 30px 0 0 30px;">Read More</a>
                                               <a href="{{route('my-posts.edit', $post)}}" class="btn btn-sm btn-primary px-3" style="border-radius: 0">Edit post</a>
